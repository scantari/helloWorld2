...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'email':'robertsmith@umd.edu', 'major_id':3,
            'birth_date': dt.datetime(2005, 6, 1), 'is_honors':1},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'email':'leovanmunching@umd.edu', 'major_id':6,
         'birth_date': dt.datetime(2004, 3, 24), 'is_honors': 0},
    ]

    for each_student in students:
        email = f"{each_student['first_name'].lower()}.{each_student['last_name'].lower()}@umd.edu"
