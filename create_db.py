...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'scantari', 'email': 'scantari@umd.edu', 'first_name': 'Sebastian', 'last_name': 'Cantarilho',
         'password': generate_password_hash('scantari', method='pbkdf2:sha256'), 'role': 'STUDENT'},
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Sebastian', 'last_name': 'Cantarilho', 'email': 'scantari@umd.edu',
         'major_id': 8, 'birth_date': dt.datetime(2005, 9, 14), 'is_honors': 1}
    ]
